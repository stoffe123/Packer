...
static void write_seqlen(uint64_t c) {
	fwrite(&c, 1, 1, (separate_files ? seq_lens_file : utfil));
}

static void write_offset(uint64_t c) {
	fwrite(&c, 1, 1, (separate_files ? offsets_file : utfil));
}

static void out_seqlen(unsigned long seqlen, unsigned char pages) {
...
static void out_offset(unsigned long offset, unsigned char pages) {
...
static void pack_internal(const char* src, const char* dest_filename, unsigned char pass,
...
static unsigned char check_pages(pages, size) {
...
void seq_pack_internal2(const char* source_filename, const char* dest_filename, unsigned char offset_pages, unsigned char seqlen_pages, bool sep) {
...
void seq_pack2(const char* source_filename, const char* dest_filename, unsigned char offset_pages, unsigned char seqlen_pages)
{
	seq_pack_internal2(source_filename, dest_filename, offset_pages, seqlen_pages, false);
}
