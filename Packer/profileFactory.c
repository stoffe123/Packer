...
completePackProfile getProfileForExtensionOrDefault(wchar_t* ext, completePackProfile def) {
	...
	.sizeMinForCanonical = 391,
	.sizeMaxForSuperslim = 63361,
	.metaCompressionFactor = 79,
	.offsetLimit1 = 173,
	.offsetLimit2 = 1650,
	.offsetLimit3 = 65957,
	.bytesWonMin = 0 },
	...
	.twobyte_ratio = 100,
	.recursive_limit = 533,
	.twobyte_threshold_max = 11060,
	.twobyte_threshold_divide = 2341,
	.twobyte_threshold_min = 113,
	.seqlenMinLimit3 = 241,
	.blockSizeMinus = 33,
	.sizeMaxForCanonicalHeaderPack = 678,
	...
	.twobyte_ratio = 93,
	.recursive_limit = 81,
	.twobyte_threshold_max = 8195,
	.twobyte_threshold_divide = 655,
	.twobyte_threshold_min = 937,
	.seqlenMinLimit3 = 76,
	.blockSizeMinus = 337,
	.sizeMaxForCanonicalHeaderPack = 285,
	.sizeMinForSeqPack = 28403,
	.sizeMinForCanonical = 406,
	...
	.twobyte_ratio = 99,
	.recursive_limit = 276,
	.twobyte_threshold_max = 8413,
	.twobyte_threshold_divide = 1931,
	.twobyte_threshold_min = 855,
	.seqlenMinLimit3 = 163,
	.blockSizeMinus = 211,
	.sizeMaxForCanonicalHeaderPack = 405,
	.sizeMinForSeqPack = 14701,
	.sizeMinForCanonical = 606,
	.sizeMaxForSuperslim = 9524,
	...
	return getCompletePackProfile(mainProfile, seqlenProfile, offsetProfile, distanceProfile);
		 ...
		 .twobyte_ratio = 69,
		 .recursive_limit = 292,
		 .twobyte_threshold_max = 1673,
		 .twobyte_threshold_divide = 3959,
		 .twobyte_threshold_min = 861,
		 .seqlenMinLimit3 = 222,
		 .blockSizeMinus = 0,
		 .sizeMaxForCanonicalHeaderPack = 271,
		 .sizeMinForSeqPack = 6585,
		 .sizeMinForCanonical = 187,
		 .sizeMaxForSuperslim = 54380,
		 ...
		 .bytesWonMin = 2
			...
			.twobyte_threshold_divide = 1810,
			.twobyte_threshold_min = 390,
			.seqlenMinLimit3 = 207,
			.blockSizeMinus = 248,
			.sizeMaxForCanonicalHeaderPack = 215,
			.sizeMinForSeqPack = 29691,
			.sizeMinForCanonical = 683,
			.sizeMaxForSuperslim = 73418,
			.metaCompressionFactor = 96,
			.offsetLimit1 = 208,
			.offsetLimit2 = 1446,
			.offsetLimit3 = 65773,
			.bytesWonMin = 10
			...
			.twobyte_ratio = 100,
			.recursive_limit = 371,
			.twobyte_threshold_max = 6499,
			.twobyte_threshold_divide = 3171,
			.twobyte_threshold_min = 867,
			.seqlenMinLimit3 = 189,
			.blockSizeMinus = 0,
			.sizeMaxForCanonicalHeaderPack = 450,
			.sizeMinForSeqPack = 10,
			.sizeMinForCanonical = 482,
			.sizeMaxForSuperslim = 100000,
			.metaCompressionFactor = 34,
			.offsetLimit1 = 232,
			.offsetLimit2 = 1860,
			.offsetLimit3 = 68264,
			.bytesWonMin = 0
			...
			.twobyte_threshold_min = 528,
			.seqlenMinLimit3 = 217,
			.blockSizeMinus = 179,
			.sizeMaxForCanonicalHeaderPack = 1151,
			.sizeMinForSeqPack = 22147,
			.sizeMinForCanonical = 585,
			.sizeMaxForSuperslim = 11436,
			.metaCompressionFactor = 135,
			.offsetLimit1 = 172,
			.offsetLimit2 = 1520,
			.offsetLimit3 = 76950,
			.bytesWonMin = 39
